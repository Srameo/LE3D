...
void CudaRasterizerCH32::Rasterizer::CH32markVisible(
	int P,
	float* means3D,
	float* viewmatrix,
	float* projmatrix,
...
CudaRasterizerCH32::GeometryState CudaRasterizerCH32::GeometryState::fromChunk(char*& chunk, size_t P)
{
	GeometryState geom;
...
CudaRasterizerCH32::ImageState CudaRasterizerCH32::ImageState::fromChunk(char*& chunk, size_t N)
{
	ImageState img;
...
CudaRasterizerCH32::BinningState CudaRasterizerCH32::BinningState::fromChunk(char*& chunk, size_t P)
{
...
// of Gaussians.
int CudaRasterizerCH32::Rasterizer::forward(
...
void CudaRasterizerCH32::Rasterizer::backward(
